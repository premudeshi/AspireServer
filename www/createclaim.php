...
$conn->close();
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="insurancecompany" name="insurancecompany">
    <?php
...
$sql = "SELECT * FROM company WHERE type = 'InsuranceCompany'";
$result = $conn->query($sql);
...
$conn1->close();
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="claimnumber" name="number">
  </div>
  <div class="form-group">
    <label for="type">Type of Claim</label>
    <select multiple class="form-control" id="type" name="type">
    <option value="Cash Fidelity">Cash Fidelity</option>
      <option value="Stock Fidelity">Stock Fidelity</option>
      <option value="Buglary">Buglary</option>
      <option value="Goods in Transport">Goods in Transport</option>
