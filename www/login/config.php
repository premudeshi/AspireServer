...
$from_email = 'web@claims.co.tz'; //Webmaster email
$from_name = 'Aspire Gateway System'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server = 'mail.claims.co.tz';
$smtp_user = 'web@claims.co.tz';
$smtp_pw = 'Aspireglobal4321!';
